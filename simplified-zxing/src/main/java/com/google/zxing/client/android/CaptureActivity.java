...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    protected void onResume() {
        ...
        if (getIntent().getBooleanExtra("portrait_mode", portrait_mode)) {
            portrait_mode = true;
        } else {
            portrait_mode = false;
        }
        ...
        SurfaceView surfaceView = findPreviewView();
    ...
    protected void onScaned(Result rawResult, Bitmap barcode) {
